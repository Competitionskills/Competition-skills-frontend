        ...
        <div className="container mx-auto px-4 max-w-[100vw]">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex space-x-4">
              <Link to="/login" className="text-gray-600 hover:text-blue-600 font-semibold transition-colors">
                Join ScorePerk
              </Link>
              <Link to="/signup" className="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-700 transition-all transform hover:scale-105 hover:shadow-lg hover:shadow-blue-200">
                Login ScorePerk
              </Link>
            </div>
          </div>
